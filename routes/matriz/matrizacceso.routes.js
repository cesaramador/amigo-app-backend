...
} from '../../middleware/matriz/matrizacceso.validator.js';
...
matrizaccesoRouter.get('/', autorizaAcceso, matrizaccesosGetValidation, matrizaccesosGet);

// path : /api/v1/matrizaccesos (GET)
// leer la matriz de acceso por id
matrizaccesoRouter.get('/:id', autorizaAcceso, idMatrizAccesoParamValidation, matrizaccesoGetById);

// path : /api/v1/matrizaccesos (POST)
// crear una nueva entrada a la matriz de acceso
matrizaccesoRouter.post('/', autorizaAcceso, matrizaccesoBodyRequiredValidation, matrizaccesoPost);

// path : /api/v1/matrizaccesos (PUT)
// actualizar una entra de la matriz de acceso por id
matrizaccesoRouter.put('/:id', autorizaAcceso, idMatrizAccesoParamValidation, matrizaccesoBodyRequiredValidation, matrizaccesoPut);

// path : /api/v1/matrizaccesos (PATCH)
// actualizar una entrdada de la matriz de acceso por id
matrizaccesoRouter.patch('/:id', autorizaAcceso, idMatrizAccesoParamValidation, matrizaccesoBodyPatchValidation, matrizaccesoPatch);

// path : /api/v1/matrizaccesos (DELETE)
// eliminar una entrdada de la matriz de acceso por id
matrizaccesoRouter.delete('/:id', autorizaAcceso, idMatrizAccesoParamValidation, matrizaccesoDelete);
